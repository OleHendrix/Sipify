...
async function postJoinGame(username, gamePin, triggerShake)
{
	if (!gamePin)
		triggerShake();
	else
  ...
  return (
    <div>
      ...
      <div className='font-bold w-[375px] h-[812px] flex justify-center items-center flex-col gap-3'>
        ...
        <Button className={'shadow-2xl'} text="Join game" onClick={() => postJoinGame(username, gamePin, triggerShake)}/>
      </div>
    </div>
  );
}
